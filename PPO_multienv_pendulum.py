...
def parse_args():
  ...
  parser.add_argument('--env', type=str, default='Pendulum-v0', help='Name of environment')
  ...
  parser.add_argument('--expert_training_step', type=int, default=int(2e6), help='Num of steps for training expert algorithm.')
  parser.add_argument('--n_env', type=int, default=8, help='Num of parallel environments to run')
  parser.add_argument('--n_steps', type=int, default=2048, help='The number of steps to run for each environment per update')
