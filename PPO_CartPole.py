...
def parse_args():
  ...
  parser.add_argument('--expert_training_step', type=int, default=int(1e4), help='Num of steps for training expert algorithm.')
  parser.add_argument('--expert_episodes', type=int, default=int(1e4), help='Num of training data generated from expert')
  parser.add_argument('--student_training_step', type=int, default=int(1e4), help='Num of steps for training imitation algorithm(student)')
...
def main(args):
  ...
  generate_expert_traj(expert_model, os.path.join(train_log_dir, 'expert_traj'), n_timesteps=1000, n_episodes=args.expert_episodes)
